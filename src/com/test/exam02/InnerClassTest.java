...
public class InnerClassTest {
    ...
    //outClass의 내부 클래스인 InClass를 인스턴스화해서 메모리에 생성하고 그 클래스변수 이름을 inClass라고 함.
     OutClass.InClass inClass1 = outClass.new InClass(); //1에서 만든 외부클래스 변수.new 내부클래스명생성자
     inClass1.Intest();
     outClass.usingClass();

     System.out.println("inClass.inNum="+inClass1.inNum);
    }
}

class OutClass{
    private int num =10; //OutClass의 멤버 변수
    private static int inNum =20; //OutClass의 멤버 변수
